...
const socialStyle =
  "hover:text-primary transition-all ease-in-out duration-300 rounded-full bg-slate-700 p-3";
...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_v1hscdh", "template_d7lxyui", form.current, {
      ...
      <div>
        <div className="flex flex-col md:flex-row gap-10">
                ...
                <div className="space-y-3 pt-10">
                  ...
                  <div className="flex gap-6">
                    ...
                    <a
                      className={socialStyle}
                      target="_blank"
                      href="https://www.facebook.com/sheikh.naim.133372/"
                    >
                      <FaSquareFacebook />
                    </a>
                  </div>
          ...
          <div className="w-full md:w-[65%] relative">
            <div className="bg-accent rounded-xl  p-6 md:p-8 py-10 shadow-[6px_6px_20px_rgba(0,0,0,0.4),-6px_-6px_20px_rgba(0,0,0,0.4)] relative z-10">
              <div className="pb-6">
                <h3 className="text-2xl text-white font-semibold">
                  Send me a message
                </h3>
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-3 ">
                <div className="flex flex-col sm:flex-row gap-5">
                  <div className="form-control flex-1">
                    ...
                    <input
                      ...
                      placeholder=""
                      className="input input-bordered border-none focus:outline-none focus:outline-primary bg-slate-700 "
                      required
                    />
                  </div>
                  <div className="form-control flex-1">
                ...
                <div className="form-control">
                  ...
                  <textarea
                    ...
                    name="message"
                    placeholder=""
                    className="input input-bordered h-28   border-none focus:outline-none focus:outline-primary bg-slate-700   "
                    required
                  />
                </div>
                <div className="pt-4">
